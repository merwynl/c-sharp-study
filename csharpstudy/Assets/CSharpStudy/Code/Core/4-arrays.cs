   ...
   public class Arrays
{
    ...
    static void Array(string[] args)
    {
        ...
        // Declaring an array of integers, doubles, floats & bool with a fixed size
        int[] order = new int[4];
    ...
    // Example 2: 2D-arrays|Multi-dimensional arrays are arrays within an array.
    // Useful if you need a grid or array of data
    static void MultiDimensionalArrays(string[] args)
    {
        // Declaring 1D arrays
